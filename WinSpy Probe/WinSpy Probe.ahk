...
» Original Source:  https://www.computoredge.com/AutoHotkey/Free_AutoHotkey_Scripts_and_Apps_for_Learning_and_Generating_Ideas.html#WindowProbe
» 
    ▹ 
∙=============================================================∙
*/
...
^!T::    ;;∙------∙🔥∙(Ctrl + Alt + T)
    Toggle := !Toggle
    SetTimer, WatchCursor, % Toggle ? 500 : "Off"
    If (!Toggle)
        ToolTip
Return
...
^F12::
    SoundBeep, 1200, 250
    Clipboard := "Unique ID: ahk_id " . id . "`r`n"
               . "Title: " . title . "`r`n"
               . "Class: ahk_class" . class . "`r`n"
               . "Control: " . control . "`r`n"
