...
∙--------∙Origins∙-------------------------∙
» Author:  Alguimist
» Original Source:  https://www.autohotkey.com/boards/viewtopic.php?f=6&t=20983&hilit=MagicBox#p100953
» MagicBox - Message Box Generator
» See Also:  MagicBox_README.txt
∙=============================================================∙
*/
;;∙------------------------------------------------------------------------------------------∙
;;∙======∙Auto-Execute∙==========================================∙
...
Menu Tray, Icon, Icons\MagicBox.ico
...
; MSGBOXDATA structure offset (SoftModalMessageBox)
If (A_Is64BitOS) {
