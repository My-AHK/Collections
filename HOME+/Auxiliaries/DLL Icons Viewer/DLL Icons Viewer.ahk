...
∙--------∙Origins∙-------------------------∙
» Original Author:  pcg
» Original Source:  https://www.autohotkey.com/boards/viewtopic.php?t=122021#p542700
...
GuiTip(hCtrl, text := "")
{
    ...
    ; If the GUI was destroyed and recreated, we need to reset hTip
