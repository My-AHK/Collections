...
Morse(Timeout = 400) {
    ...
    While, !ErrorLevel {
        ...
        If (PressDuration > Timeout) {
            SoundBeep, 800, 200    ;;∙------∙Long beep for pressed too long.
            Pattern .= 1
        } Else {
       ;     SoundBeep, 1100, 75    ;;∙------∙Short beep for short press.
            Pattern .= 0
        }
...
;;∙------∙MENU-HEADER∙---------------∙
DotSymbolSender:    ;;∙------∙Suspends hotkeys then pauses script.
    Suspend
    Soundbeep, 700, 100
    Pause
Return
