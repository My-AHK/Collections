...
/*
;;∙------∙The first line of code below is the set of letters, digits, and/or symbols that are eligible for this type of correction.
...
#H::    ;;∙------∙🔥∙(Win + H)
;;∙------∙Get the selected text. The clipboard is used instead of "ControlGet Selected" as it works in more editors and word processors, java apps, etc. Save the current clipboard contents to be restored later.
...
;;∙------∙I have included all the ones compatible with reasonable codepages, and placed those that may often not be accented either from a clash with an unaccented word (resume), or because the unaccented version is now common (cafe).
::aesop::Æsop
::a bas::à bas
::a la::à la
...
;;∙============∙ * Ambiguous Entries * ∙============∙
;;∙------∙Where desired, pick the one that's best for you, edit, and move into the above list or, preferably, the autocorrect user file.
/*
:*:cooperat::coöperat
::(c)::©
::(r)::®
...
:?:oology::oölogy
:?:t he:: the    ;;∙------∙Can't use this. Needs to be more clever.
*/
;;∙============================================================∙
;;∙============================================================∙
...
;;∙====⮟=∙Anything below this point was added to the script by the user via Win+H hotkey∙=⮟====∙
