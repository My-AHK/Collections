...
» Original Source:  https://www.autohotkey.com/boards/viewtopic.php?f=76&t=100921&p=448315#p448315
» 
    ▹ 
∙=============================================================∙
*/
...
MsgBox, 64, Battery status, %battRemaining%`% remaining, 3
MsgBox, 64, Battery status, % batt.2 "% remaining`nStatus: " batt.3 "`nDescription: " batt.4, 3
