...
MsgBox,,, % IsProcessElevated(DllCall("GetCurrentProcessId")),3
Return
*/

;;∙--------∙Example∙--------∙
elevated := IsProcessElevated(DllCall("GetCurrentProcessId"))
MsgBox,,, % "Is the Process Elevated...`n`t`t- " (elevated ? "Yes" : "No")" -", 3
Return
