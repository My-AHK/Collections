...
BarX := ((A_ScreenWidth / 20) * 19) - 190    ;;∙------∙Adjust the 190 value as needed for horizontal.
BarY := (A_ScreenHeight / 2) + 440    ;;∙------∙Adjust the 440 value as needed for vertical.
Volume_ProgressbarOpts = CW000000 CTFFFFFF CBA8D4FD x%BarX% y%BarY% w260 h52 B1 FS8 WM700 WS700 FM8 ZH12 ZY3 C11
