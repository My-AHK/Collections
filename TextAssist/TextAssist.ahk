...
∙--------∙Origins∙-------------------------∙
» Author:  MrFace1
» Original Source:  https://pastebin.com/g6BzS4A8
» Addition Source:  https://www.autohotkey.com/boards/viewtopic.php?t=114808#p511756

∙--------------------------------------------∙

• Hotkey Trigger    ;;∙------∙(Ctrl+Y)∙🔥HOTKEY🔥∙
...
;;∙------------------------------------------------------------------------------------------∙
;;∙======∙Auto-Execute∙==========================================∙
ScriptID := "TextAssist"    ;;∙------∙Also change in 'MENU CALLS' at script end.
GoSub, AutoExecute
GoSub, TrayMenu
;;∙============================================================∙
;;∙------------------------------------------------------------------------------------------∙
...
GuiBegin:
    Gui, +AlwaysOnTop -Caption +hwndHGUI 
            +LastFound +E0x02000000 +E0x00080000;;∙------∙Double Buffer to reduce Gui flicker.
    Gui, Color, BLACK
    Gui, Font, s14 cF5DE00, ARIAL
    Gui, Margin, 15, 15
    Gui, Add, Text, w150 h50 Center +BackgroundTrans +0x0200 0x00800000, ATTENTION!!
    Gui, Font, s10
Return
;;∙------------------------∙
GuiEnd:
...
SetTitleMatchMode 2
SetWinDelay 0
Menu, Tray, Icon, compstui.dll, 82
Return
;;∙============================================================∙
;;∙------------------------------------------------------------------------------------------∙
;;∙======∙Tray Menu∙============================================∙
...
;;∙------------------------------------------------------------------------------------------∙
;;∙======∙MENU CALLS∙==========================================∙
TextAssist:    ;;∙------∙Suspends hotkeys then pauses script. (Script Header)
    Suspend
    Soundbeep, 700, 100
    Pause
Return
