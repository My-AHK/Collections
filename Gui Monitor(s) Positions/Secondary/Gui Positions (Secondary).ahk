...
» Updated Source:  https://www.autohotkey.com/boards/viewtopic.php?style=17&t=117207#p522838
» 2 Options:
...
Gui, Add, Text, xp y+5 Center BackgroundTrans, Press Alt +`n'Alphanumeric' or`n'Numpad' Keys to`ncycle through options
;;∙------------------------∙
...
WinMove(hwnd, position) {
    ...
    2x := InStr(position, "l") ? Mon2Left : InStr(position, "hc") ? ((Mon2Right - Mon2Left - w) / 2) + Mon2Left : InStr(position, "r") ? Mon2Right - w : ix + Mon2Right
    2y := InStr(position, "u") ? Mon2Top : InStr(position, "vc") ? ((Mon2Top + Mon2Bottom - h) / 2) - Mon2Top : InStr(position, "d") ? Mon2Bottom - h : iy + Mon2Top
    WinMove, ahk_id %hwnd%,, 2x, 2y
