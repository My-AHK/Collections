...
;;∙======∙Calculate actual height based on all GUI elements.
guiH := (guiFontSize + 10) + guiFontSize2 + 10 + (guiSelectSize + 10) + (guiBoxSize + 20) + 30 + (guiFontSize + 8) ; + 15
;;∙----∙Calculate height based on all GUI elements:
;;∙------∙Top padding + "Hours Minutes Seconds" text: (guiFontSize + 10)
;;∙------∙StopWatch display height: guiFontSize2
;;∙------∙Space before "Select Time": 10
;;∙------∙"Select Time" text height + spacing: (guiSelectSize + 10)
;;∙------∙ComboBoxes height + spacing: (guiBoxSize + 20)
;;∙------∙Buttons height + spacing: 30
;;∙------∙Icon row height: (guiFontSize + 8)
;;∙------∙Bottom padding: 15 (if needed)
