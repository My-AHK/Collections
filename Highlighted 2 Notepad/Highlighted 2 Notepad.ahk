...
;;∙============================================================∙
;;======Set Paths===Define global variables======
;;------ Change the Folder and File names betweeen the "quotes" and keeping the back\slash.
;;------    ~  Same folder\file as script  ~
;FolderPath := A_ScriptDir "\FolderName"
FolderPath := A_ScriptDir "\Clipped Notes"

;FilePath := FolderPath "\FileName.txt"
FilePath := FolderPath "\Log Entries.txt"
