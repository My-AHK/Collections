...
» Original Source:  https://www.autohotkey.com/board/topic/29706-printing-selected-text/
...
^!p::
    MouseGetPos, mx, my
    Soundbeep, 1100, 200
    ToolTip, Printing selection... Please wait., % mx - 20, % my - 30
    BlockInput, On
    ...
    ClipWait, 2
    if ErrorLevel {
        MsgBox, 48, Error, Clipboard copy failed.
