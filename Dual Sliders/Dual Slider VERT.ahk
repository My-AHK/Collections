...
∙--------∙Origins∙-------------------------∙
» Author:  Laszlo
» Source:  https://www.autohotkey.com/board/topic/34174-dual-slider/
» Simple visual interface with two interdependent sliders.
∙=============================================================∙
*/
;;∙------------------------------------------------------------------------------------------∙
;;∙======∙Auto-Execute∙==========================================∙
...
2SlidH := 123    ;;∙------∙Tthe height of the scale.
2SlidK := 2SlidH/100, 2SlidU := 2SlidH+19, 2SlidV := 2SlidU-1    ;;∙------∙Auxiliary variables.

Gui, Add, Progress, x20 y40 w3 h%2SlidH% Vertical BackgroundBlue Disabled
Loop 2
    Gui, Add, Slider, x15 y30 h%2SlidU% v2Slid%A_Index% g2Slid%A_Index% hwnd2SlidHwnd%A_Index% AltSubmit Range0-100 TickInterval10 Thick13 -Theme ToolTip Vertical
        GoSub, 2Slid
    Gui, +AlwaysOnTop -Border
    Gui, Color, Aqua
    Gui, Show, x1600 w50 h200
Return
