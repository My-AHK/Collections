...
Text := "Some Text For Contrast"    ;;∙------∙Text to display.
offSet := "2"    ;;∙------∙Shadow text offset.
...
Gui, New, +AlwaysOnTop -Caption -DPIScale +HwndIDNew +LastFound
Gui, Color, % Color
Gui, Margin, 20, 20
Gui, Font, s18 BOLD q5, Verdana
Gui, Add, Text, Center vText1 c000000 BackgroundTrans, % Text    ;;∙------∙Shadow Text.
Gui, Add, Text, xp-%offSet% yp-%offSet% Center vText2 cFFFF00 BackgroundTrans, % Text
;;∙---------------------------------------------∙
Gui, Show, NA %PosNew%
